...
from LBSR.data_precompute.input_output import convert_pdb_to_pqr, convert_pqr_to_xyzrn
from LBSR.utils.helpers import mp_run, subprocess_run


default_pdb2pqr = os.environ.get('PDB2PQR_BIN', subprocess_run('which pdb2pqr30'))
print('default_pdb2pqr:', default_pdb2pqr)
...
if __name__ == '__main__':
    ...
    print('args.pdb2pqr_bin:', args.pdb2pqr_bin)
